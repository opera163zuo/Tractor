...
namespace Kuaff.Tractor
{
    ...
    class DrawingFormHelper
    {
        ...
        private void SyncRankStateToGameState()
        {
            ...
            mainForm._gameState.IsNew = mainForm.isNew;
            mainForm._gameState.ShowSuits = mainForm.showSuits;
            mainForm._gameState.WhoShowRank = mainForm.whoShowRank;
        }
        ...
        internal void ReadyCards(int count)
        {
            ...
            if (mainForm.gameConfig.IsDebug)
            {
                ...
                mainForm.renderer.DrawRankOrNotUI(mainForm.bmp, mainForm._gameState);
            }
            else
            {
            ...
            //是否亮主
            DoRankOrNotLogic(mainForm.currentPokers[1], 2);
            mainForm.renderer.DrawRankOrNotUI(mainForm.bmp, mainForm._gameState);
            ...
            //是否亮主
            DoRankOrNotLogic(mainForm.currentPokers[2], 3);
            mainForm.renderer.DrawRankOrNotUI(mainForm.bmp, mainForm._gameState);
            ...
            //画亮的牌
            mainForm.renderer.DrawSuitUI(mainForm.bmp, mainForm._gameState);
            //是否亮主
            DoRankOrNotLogic(mainForm.currentPokers[3], 4);
            mainForm.renderer.DrawRankOrNotUI(mainForm.bmp, mainForm._gameState);
        ...
        #region 判断是否亮主
        //是否应该亮主,调用算法
private void DoRankOrNotLogic(CurrentPoker currentPoker, int user)
        {
            //如果打无主，无需再判断
